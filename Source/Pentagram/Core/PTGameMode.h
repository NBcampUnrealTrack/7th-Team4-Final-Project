...
public:
    ...
    void RespawnPlayer(AController* PlayerController); //리스폰 플레이어
    void RespawnPlayer(AController* PlayerController, const FVector& RespawnLoc, bool bHasCheckpoint); //리스폰 플레이어
